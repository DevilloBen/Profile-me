...
const Header = ({ headings, site, github, linkedin, location, phone, email }: HeaderResumeProps) => (
  <header className="text-right dont-page-break">
    <Headings {...headings} />

    {site && (
      <p className="text-base">
        <a target="_blank" rel="noreferrer" href="https://devillo.vercel.app/" className="link">
          devillo.vercel.app
        </a>
      </p>
    )}
    ...
    {location && <p className="text-muted text-base">Thailand, Bangkok (UTC-7)</p>}
